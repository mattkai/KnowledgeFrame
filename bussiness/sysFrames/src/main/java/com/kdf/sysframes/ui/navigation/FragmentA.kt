package com.kdf.sysframes.ui.navigation
...
class FragmentA : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val btnFa = view.findViewById<AppCompatButton>(R.id.btn_fragment_b)
        val btnFc = view.findViewById<AppCompatButton>(R.id.btn_fragment_c)
